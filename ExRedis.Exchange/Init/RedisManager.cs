...
namespace ExRedis.Exchange.Init
{
    /// <summary>
    /// Redis基本信息初始化辅助类
    /// </summary>
    internal class RedisManager
    {
        ...
        /// </summary>
        internal static readonly string RedisSysCustomKey = Comm.ConfigHelper.GetConfig<string>("RedisSysCustomKey");
        /// <summary>
        /// 当前连接的Redis中的DataBase索引，默认0-16，可以在service.conf配置，最高64
        /// </summary>
        internal static readonly int RedisDataBaseIndex = Comm.ConfigHelper.GetConfig<int>("RedisDataBaseIndex");
        /// <summary>
        /// 当前连接的Redis中连接字符串，格式为：127.0.0.1:6379,allowadmin=true,passowrd=pwd
        /// </summary>
        internal static readonly string RedisHostConnection = Comm.ConfigHelper.GetConfig<string>("RedisHostConnection");
