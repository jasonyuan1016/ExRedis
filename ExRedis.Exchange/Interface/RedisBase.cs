...
namespace ExRedis.Exchange.Interface
{
    /// <summary>
    /// Redis操作方法基础类
    /// </summary>
    public abstract class RedisBase : IDisposable
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static ExString StringService => new ExString();
        /// <summary>
        /// 获取Redis的Hash数据类型操作辅助方法类
        /// </summary>
        /// <returns></returns>
        public static ExHash HashService => new ExHash();
        /// <summary>
        /// 获取Redis的List数据类型操作辅助方法类
        /// </summary>
        /// <returns></returns>
        public static ExList ListService => new ExList();
        /// <summary>
        /// 获取Redis的Set无序集合数据类型操作辅助方法类
        /// </summary>
        /// <returns></returns>
        public static ExSet SetService => new ExSet();
        /// <summary>
        /// 获取Redis的SortedSet(ZSet)有序集合数据类型操作辅助方法类
        /// </summary>
        /// <returns></returns>
        public static ExSortedSet SortedSetService => new ExSortedSet();
