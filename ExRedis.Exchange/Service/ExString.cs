...
{
    /// <summary>
    /// String：key-value 键值对，value可以是序列化的数据
    /// </summary>
    public class ExString : RedisBase
    {
        #region 构造函数
        ...
        public ExString(int? dbNum = null) :
            base(dbNum)
        { }
        #endregion
        ...
        public void ResetExpiry(string key, TimeSpan? expiry = default(TimeSpan?))
        {
