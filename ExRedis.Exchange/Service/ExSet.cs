using ExRedis.Exchange.Interface;
...
namespace ExRedis.Exchange.Service
{
    /// <summary>
    ...
    public class ExSet : RedisBase
    {
        ...
        {
            return SetCombine<T>(SetOperation.Union, keys);
        }
        ...
        {
            return SetCombine<T>(SetOperation.Intersect, keys);
        }
        /// <summary>
        /// 获取几个集合的差集
        /// </summary>
        ...
        {
            return SetCombine<T>(SetOperation.Difference, keys);
        }
        ...
        {
            return await SetCombineAsync<T>(SetOperation.Union, keys);
        }
        /// <summary>
        /// 获取几个集合的交集
        /// </summary>
        ...
        {
            return await SetCombineAsync<T>(SetOperation.Intersect, keys);
        }
        /// <summary>
        /// 获取几个集合的差集
        /// </summary>
        ...
        {
            return await SetCombineAsync<T>(SetOperation.Difference, keys);
        }
        ...
        {
            return await SetCombineAndStoreAsync(SetOperation.Union, destination, keys);
        }
        /// <summary>
        /// 获取几个集合的交集,并保存到一个新Key中
        /// </summary>
        ...
        {
            return await SetCombineAndStoreAsync(SetOperation.Intersect, destination, keys);
        }
        /// <summary>
        /// 获取几个集合的差集,并保存到一个新Key中
        /// </summary>
        ...
        {
            return await SetCombineAndStoreAsync(SetOperation.Difference, destination, keys);
        }
        /// <summary>
        /// 获取几个集合的交叉并集合
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="operation">Union：并集  Intersect：交集  Difference：差集</param>
        /// <param name="keys">要操作的Key集合</param>
        /// <returns></returns>
        ...
        /// <param name="keys">要操作的Key集合</param>
        /// <returns></returns>
        public List<string> SetCombine(SetOperation operation, params string[] keys)
        {
            RedisKey[] keyList = base.ConvertRedisKeysAddSysCustomKey(keys);
            var rValue = base.redis.SetCombine(operation, keyList);
        ...
        /// <param name="keys">要操作的Key集合</param>
        /// <returns></returns>
        private long SetCombineAndStore(SetOperation operation, string destination, params string[] keys)
        {
        ...
        /// <param name="keys">要操作的Key集合</param>
        /// <returns></returns>
        private async Task<List<T>> SetCombineAsync<T>(SetOperation operation, params string[] keys)
        {
            RedisKey[] keyList = base.ConvertRedisKeysAddSysCustomKey(keys);
        ...
        /// <param name="keys">要操作的Key集合</param>
        /// <returns></returns>
        private async Task<long> SetCombineAndStoreAsync(SetOperation operation, string destination, params string[] keys)
        {
            destination = AddSysCustomKey(destination);
            RedisKey[] keyList = base.ConvertRedisKeysAddSysCustomKey(keys);
